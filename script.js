...
const arrayPassiveButtons = [
	{ name: "Floppy Disk", price: "500 octets" },
	{ name: "Floppy Disko", price: "2000 octets" },
	{ name: "Floppy Diskator", price: "5000 octets" },
];
...
const arrayActiveButtons = [
	{ name: "Gaming Mouse", price: "100 octets" },
	{ name: "Mac Intosh", price: "1000 octets" },
	{ name: "PC", price: "10000 octets" },
];

const activeButtonsContainer = document.querySelectorAll(
	".button-bonus1, .button-bonus2, .button-bonus3",
);
